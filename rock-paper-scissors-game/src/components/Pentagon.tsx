...
const Pentagon: React.FunctionComponent< PentagonProps> = ({toggle, handleToggleDisplay}) => {
  return (
    <section className={toggle?"pentagon-container":"triangle-container"}>
        ...
        {toggle && <Lizard classType="circle lizard" handleToggleDisplay={handleToggleDisplay}/>}
        {toggle && <Spock classType="circle spock" handleToggleDisplay={handleToggleDisplay} />}
     </section>
     );
};
